...
Static SEO site for k1pkhub.com.

## Deployment

1. Create a GitHub repository named `k1pkhub.com` under `alexgkbet888-web`.
2. Push this folder to the repository `main` branch.
3. Enable GitHub Pages from `main` / root.
4. Keep the root `CNAME` file as `k1pkhub.com`.
...
- Submit `https://k1pkhub.com/sitemap.xml` in Google Search Console.
